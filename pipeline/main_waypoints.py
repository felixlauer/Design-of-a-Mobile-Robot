...
#target waypoints
waypoint_x = [p[0] for p in all_waypoints]
waypoint_y = [p[1] for p in all_waypoints]
plt.scatter(waypoint_x, waypoint_y, c='yellow', marker='o', s=60, edgecolors='black', label='Given Waypoints')
...
plt.title("Multi-Waypoint Autonomous Navigation")
plt.legend()
plt.axis('off') 
plt.show()